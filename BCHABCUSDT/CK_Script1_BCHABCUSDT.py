...
def Market_Price_Binance():
    ...
    print(prices[408])
    if(prices[408]['symbol']== 'BCHABCUSDT'):                    #Change this to get different LTP for diff market
        LTP_Binance = float(prices[408]['price'])
        print("Market price of BCHABCUSDT -> ", LTP_Binance)
        return LTP_Binance
...
market_name = "BCHABCUSDT"                                    # Enter the Market Name you want to trade in
...
lower_bound_amt = 0.133
upper_bound_amt = 0.612
